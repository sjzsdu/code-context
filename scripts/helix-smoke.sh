...
answer_cli="$(run_code_context answer "Where is HealthMessage used?" --profile plan-implementation --system-prompt "Answer from smoke evidence and cite sources." --require-citations --min-citation-coverage 0.1 --evaluate --min-evaluation-score 0.2 --json --limit 5)"
printf '%s\n' "$answer_cli"
